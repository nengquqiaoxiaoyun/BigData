...
文件压缩有两大好处：**减少存储文件所需要的磁盘空间，并加速数据在网络和磁盘上的传输。这两点对于处理大量数据时相当重要**
...
![image-20210715111845646](assets/image-20210715111845646.png)

![image-20210715111853846](assets/image-20210715111853846.png)
...
数据量非常大，考虑支持切片的Bzip2和**LZO**

2. Map输出阶段

该阶段无需切片，重点考虑压缩/解压缩速度：**LZO/Snappy**
